...
class AppTheme {
  ...
  // Primary color palette - Vibrant orange for energy and innovation
  static const Color primaryLight = Color(0xFFFB8705); // Main orange
  static const Color primaryDark = Color(0xFFFF9800);
  static const Color primaryVariant = Color(0xFFE65100); // Darker orange

  // Secondary color palette - Complementary blue for balance
